<html>
<head>
<title>Vehicle Brand Added</title>
...
<?php
    ...
    $details=$_POST['details'];
	  $sql="insert into vehiclebrand(name,details) values('$name','$details')";
    if(mysqli_query($conn,$sql))
    {
        echo "<h3 align='center'>Vehicle Brand Added Successfully</h3>";
    }
    else 
    {
        echo "<h3 align='center'>Could not insert record </p>".mysqli_error($conn);
    }
	mysqli_close($conn);
?>
