<html>
<head>
<title>Vehicle Update Success</title>
...
<?php
	...
	{
	    echo '<h2 align=center>Vehicle Data Updated Successfully.</h2><br>';
    }
    $vbrid=$_POST['vbrid'];
	$price=$_POST['price'];
	$sql="update vehicle set price='$price' where vbrid='$vbrid'";
	if(mysqli_query($conn,$sql))
	{
		echo "<p align=center>Vehicle Data Updated Successfully.</p>";
	}
	else
	{
		echo "<p>Could not update record ".mysqli_error($conn)."</p>";
	}
	mysqli_close($conn);
?>
</body>
