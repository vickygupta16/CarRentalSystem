<html>
<head>
<title>Vehicle Testimonial Status</title>
...
<?php
    ...
    $vid=$_POST['vid'];
    $vt=$_POST['vt'];
	$sql="insert into vehicletestimonial(vid,test) values('$vid','$vt')";
    if(mysqli_query($conn,$sql))
    {
        echo "<h3 align='center'>Vehicle Testimonials Details Added Successfully</h3>";
    }
    else 
    {
        echo "<h3 align='center'>Could not insert record</h3>".mysqli_error($conn);
    }
	mysqli_close($conn);
?>
</body>
