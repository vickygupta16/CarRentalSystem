...
<div class="container" align="center">
    <h3>Update/Edit Vehicle Details</h3>
    <form method="post" action="editvs.php">
        <table cellpadding="20px" style="text-align:center;box-shadow:10px 10px 5px grey;">
            ...
            <tr>
                <td><label for="price">Price</td>
                <td><input type="text" name="price" id="price" required style="text-align:center"/>
            </tr>
            <tr align="center">
