...
<?php
    ...
    $vboid=$_POST['vboid'];
    $c=$_POST['c'];
	$sql="update vehiclebooking set status='$c' where vboid='$vboid'";
	if(mysqli_query($conn,$sql))
	{
		echo "<p align=center>Vehicle Booking Request Updated Successfully.</p>";
	}
	else
	{
		echo "<p>Could not update booking request ".mysqli_error($conn)."</p>";
    }
	mysqli_close($conn);
?>
</body>
